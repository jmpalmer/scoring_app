...
class AlliancesControllerTest < ActionController::TestCase
  ...
  test "should create alliance" do
    assert_difference('Alliance.count') do
      post :create, alliance: { team1_id: @alliance.team1_id, team2_id: @alliance.team2_id, team3_id: @alliance.team3_id }
    end
  ...
  test "should update alliance" do
    put :update, id: @alliance, alliance: { team1_id: @alliance.team1_id, team2_id: @alliance.team2_id, team3_id: @alliance.team3_id }
    assert_redirected_to alliance_path(assigns(:alliance))
  end
